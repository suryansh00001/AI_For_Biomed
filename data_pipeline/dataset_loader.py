...
def get_brats_data_directory():
    ...
    local_candidates = [
        'd:/Brain tumorr/data/BraTS2020_TrainingData',
        'd:/Brain tumorr/BraTS2020_TrainingData',
        './data',
    ]
...
class BraTS2DSliceDataset(Dataset):
    ...
    """
    def __init__(self, data_dir=None, is_training=True, max_subjects=50, slice_step=2, filter_empty=True):
        self.data_dir = data_dir or get_brats_data_directory()
        self.is_training = is_training
